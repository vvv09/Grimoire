    ...
    <section class="pt-5">
        ...
        <div class="row wow fadeIn">
            ...
            <div class="col-lg-7 col-xl-7 ml-xl-4 mb-4">
                ...
                <p class="grey-text">Get started with MDBootstrap, the world's most popular Material Design framework
                    for
                    building responsive,
        ...
        <div class="row mt-3 wow fadeIn">
            ...
            <div class="col-lg-7 col-xl-7 ml-xl-4 mb-4">
                ...
                <p class="grey-text">Learn how to create a smart website which learns your user and reacts properly to
                    his
                    behavior.</p>
        ...
        <div class="row wow fadeIn">
            ...
            <div class="col-lg-7 col-xl-7 ml-xl-4 mb-4">
                ...
                <p class="grey-text">Push messaging provides a simple and effective way to re-engage with your users and
                    in
                    this tutorial
